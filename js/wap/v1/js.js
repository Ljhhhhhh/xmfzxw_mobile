(function ($) {
    ...
    function add(data){
        ...
        for( i = addNum - stepLength+1; i < addNum+1; i++){
            litext  +='' +
                '<li><a><img src="images/wap/v1/07xgt.jpg" alt=""><h5>室内设计</h5><p>设计时应该考虑满足人的使用要求以及对人的行为进行限制，住宅是人温馨的港湾，让人生活起来舒服应该是来舒服应该是来舒服应该是来舒服应该是装修的。</p></a></li>'
        }
        //添加进详情列别里面
        el.append(litext);
